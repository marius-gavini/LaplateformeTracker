...
public class StudentStatistics {
    ...
    public StudentStatistics(double averageGrade, int totalStudents, int studentsUnder18, int students18To25, int studentsOver25) {
    ...
    public String toString() {
        return String.format(
            ...
            totalStudents, averageGrade, studentsUnder18, students18To25, studentsOver25
        );
    }
}